...
__CONFIG__ = {'webhook': None, 'ping': False, 'pingtype': 'Here', 'error': False, 'startup': False, 'defender': False, 'systeminfo': True, 'backupcodes': False, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': True, 'wifi': True, 'killprotector': False, 'antidebug_vm': False, 'discord': True, 'anti_spam': False, 'self_destruct': False}
